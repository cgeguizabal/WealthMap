...
/// <summary>
/// Saving toward a specific product (e.g. PlayStation 6). Deadline is optional —
/// without one there is no required-monthly figure and no schedule to fall behind.
/// </summary>
public class ProductGoal : BaseEntity
{
    ...
    public void UpdateDetails(string name, Money targetAmount, DateOnly? deadline)
    {
