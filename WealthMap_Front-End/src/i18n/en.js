...
/** Sentences that wrap a figure. The number is a placeholder so word order can move. */
  ...
  settings: {
    ...
    emailNotEditable: 'Your email identifies your account and cannot be changed here.',
    currencyHint: 'Totals are shown in this currency. Nothing is converted — holdings in other currencies are left out of the totals rather than exchanged.',
    security: 'Security',
    securitySubtitle: 'Change the password you sign in with.',
    changePassword: 'Change password',
    changePasswordNote: 'Changing your password signs you out everywhere, including here. That is the point: whoever else had a session loses it too.',
