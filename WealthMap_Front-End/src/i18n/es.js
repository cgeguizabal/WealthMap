...
/** Frases que envuelven una cifra. El número es un marcador para poder mover el orden. */
  ...
  settings: {
    ...
    emailNotEditable: 'Tu correo identifica tu cuenta y no se puede cambiar aquí.',
    currencyHint: 'Los totales se muestran en esta moneda. No se convierte nada: los saldos en otras monedas quedan fuera de los totales en lugar de cambiarse.',
    security: 'Seguridad',
    securitySubtitle: 'Cambia la contraseña con la que inicias sesión.',
    changePassword: 'Cambiar contraseña',
    changePasswordNote: 'Cambiar tu contraseña cierra la sesión en todos lados, incluido aquí. De eso se trata: quien más tuviera una sesión también la pierde.',
